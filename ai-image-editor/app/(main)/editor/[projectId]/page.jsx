    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-foreground/70">Loading EasyEdit...</p>
        </div>
      </div>
    );
  }
    ...
    >
      ...
      <div className="hidden lg:block min-h-screen bg-background">
        <div className="flex flex-col h-screen">
          {processingMessage && (
            <div className="fixed inset-0 bg-background/40 backdrop-blur-md z-[100] flex items-center justify-center">
              <div className="bg-card border border-white/10 rounded-3xl p-10 flex flex-col items-center gap-6 shadow-2xl">
                <div className="relative">
                  <RingLoader color="var(--primary)" size={80} />
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-12 h-12 bg-white/10 rounded-full animate-ping" />
                  </div>
                </div>
                <div className="text-center">
                  <p className="text-foreground font-bold text-xl tracking-tight">{processingMessage}</p>
                  <p className="text-foreground/50 text-sm mt-2 max-w-[200px]">
                    Optimizing your creation. Please stay on this tab.
                  </p>
                </div>
              </div>
            </div>
