          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-1">
              <Button
                variant="ghost"
                size="sm"
                className={`text-foreground ${!canUndo ? "opacity-30 cursor-not-allowed" : "hover:bg-black/5"}`}
                onClick={handleUndo}
              ...
              <Button
                variant="ghost"
                size="sm"
                className={`text-foreground ${!canRedo ? "opacity-30 cursor-not-allowed" : "hover:bg-black/5"}`}
                onClick={handleRedo}
